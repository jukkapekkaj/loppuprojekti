\doxysection{serialib Class Reference}
\hypertarget{classserialib}{}\label{classserialib}\index{serialib@{serialib}}
...
int \mbox{\hyperlink{classserialib_a134e80527629697de7d974a35ddf1d21}{read\+Char}} (char \texorpdfstring{$\ast$}{*}p\+Byte, const unsigned int time\+Out\+\_\+ms=0)
...
int \mbox{\hyperlink{classserialib_ab6ddd91886eec65d3b727532e2b3d710}{write\+String}} (const char \texorpdfstring{$\ast$}{*}String)
\begin{DoxyCompactList}\small\item\em Write a string on the current serial port. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classserialib_ab155c84352ddefe1304d391c19497ac1}{read\+String}} (char \texorpdfstring{$\ast$}{*}received\+String, char final\+Char, unsigned int max\+Nb\+Bytes, const unsigned int time\+Out\+\_\+ms=0)
\begin{DoxyCompactList}\small\item\em Read a string from the serial device (with timeout) \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classserialib_ae5cfd575df8030105cf321e645e5db85}{write\+Bytes}} (const void \texorpdfstring{$\ast$}{*}Buffer, const unsigned int Nb\+Bytes)
\begin{DoxyCompactList}\small\item\em Write an array of data on the current serial port. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classserialib_ab05e51ff3bc47c02d7d000d58b45a961}{read\+Bytes}} (void \texorpdfstring{$\ast$}{*}buffer, unsigned int max\+Nb\+Bytes, const unsigned int time\+Out\+\_\+ms=0, unsigned int sleep\+Duration\+\_\+us=100)
...
\begin{DoxyCompactList}\small\item\em Empty receiver buffer Note that when using serial over USB on Unix systems, a delay of 20ms may be necessary before calling the flush\+Receiver function. \end{DoxyCompactList}\item 
...
\Hypertarget{classserialib_a26166f63ad73013ca7cbcd2ae59edc91}\label{classserialib_a26166f63ad73013ca7cbcd2ae59edc91} 
...
\Hypertarget{classserialib_ac44215001ae198f2c196bb7993327a4b}\label{classserialib_ac44215001ae198f2c196bb7993327a4b} 
\index{serialib@{serialib}!````~serialib@{\texorpdfstring{$\sim$}{\string~}serialib}}
\index{````~serialib@{\texorpdfstring{$\sim$}{\string~}serialib}!serialib@{serialib}}
\doxysubsubsection{\texorpdfstring{\texorpdfstring{$\sim$}{\string~}serialib()}{\string~serialib()}}
{\footnotesize\ttfamily serialib\+::\texorpdfstring{$\sim$}{\string~}serialib (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}
...
\Hypertarget{classserialib_a50c91bf8cab23afdfdf05ca58392456f}\label{classserialib_a50c91bf8cab23afdfdf05ca58392456f} 
...
\end{DoxyReturn}
\Hypertarget{classserialib_adf49bff6401d3101b41fb52e98309635}\label{classserialib_adf49bff6401d3101b41fb52e98309635} 
...
\end{DoxyReturn}
\Hypertarget{classserialib_ab0b5882339240002fccf7701f5321e0a}\label{classserialib_ab0b5882339240002fccf7701f5321e0a} 
...
If the function fails, the return value is false If the function succeeds, the return value is true. 
\end{DoxyReturn}
\Hypertarget{classserialib_a8a1c8803c8df1a19222d6006328534b8}\label{classserialib_a8a1c8803c8df1a19222d6006328534b8} 
...
\Hypertarget{classserialib_a3dc0ec56e84ab2b43dc02fc2e02148a1}\label{classserialib_a3dc0ec56e84ab2b43dc02fc2e02148a1} 
...
If the function fails, the return value is false If the function succeeds, the return value is true. 
\end{DoxyReturn}
\Hypertarget{classserialib_a572dd8d208511ec81d848de72cb05c7a}\label{classserialib_a572dd8d208511ec81d848de72cb05c7a} 
...
Empty receiver buffer Note that when using serial over USB on Unix systems, a delay of 20ms may be necessary before calling the flush\+Receiver function. 

\begin{DoxyReturn}{Returns}
If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
\end{DoxyReturn}
\Hypertarget{classserialib_aca544a6f8dfa33f8e771713646768215}\label{classserialib_aca544a6f8dfa33f8e771713646768215} 
...
\end{DoxyReturn}
\Hypertarget{classserialib_a5f451a5eea7c8c1bdcff684ba131d6ff}\label{classserialib_a5f451a5eea7c8c1bdcff684ba131d6ff} 
...
false otherwise 
\end{DoxyReturn}
\Hypertarget{classserialib_a673ed2a43c45a42f96635e54ff38715e}\label{classserialib_a673ed2a43c45a42f96635e54ff38715e} 
...
\Hypertarget{classserialib_a3f1f0894543dfb17955de50157965dd7}\label{classserialib_a3f1f0894543dfb17955de50157965dd7} 
...
\end{DoxyReturn}
\Hypertarget{classserialib_a4ec78286be81602bf1df44a4eb8372a8}\label{classserialib_a4ec78286be81602bf1df44a4eb8372a8} 
...
Return true if CTS is set otherwise false 
\end{DoxyReturn}
\Hypertarget{classserialib_a605d8a8015fadb5db5521350aefe084e}\label{classserialib_a605d8a8015fadb5db5521350aefe084e} 
...
\end{DoxyReturn}
\Hypertarget{classserialib_ab2b121af07fb732f82668f6a14e93cfb}\label{classserialib_ab2b121af07fb732f82668f6a14e93cfb} 
...
\end{DoxyReturn}
\Hypertarget{classserialib_afcef685b74a3db58dc2d1898bb34aaca}\label{classserialib_afcef685b74a3db58dc2d1898bb34aaca} 
...
\end{DoxyReturn}
\Hypertarget{classserialib_ab05e51ff3bc47c02d7d000d58b45a961}\label{classserialib_ab05e51ff3bc47c02d7d000d58b45a961} 
...
{\footnotesize\ttfamily int serialib\+::read\+Bytes (\begin{DoxyParamCaption}\item[{void \texorpdfstring{$\ast$}{*}}]{buffer,  }\item[{unsigned int}]{max\+Nb\+Bytes,  }\item[{const unsigned int}]{time\+Out\+\_\+ms = {\ttfamily 0},  }\item[{unsigned int}]{sleep\+Duration\+\_\+us = {\ttfamily 100} }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classserialib_a134e80527629697de7d974a35ddf1d21}\label{classserialib_a134e80527629697de7d974a35ddf1d21} 
...
{\footnotesize\ttfamily int serialib\+::read\+Char (\begin{DoxyParamCaption}\item[{char \texorpdfstring{$\ast$}{*}}]{p\+Byte,  }\item[{const unsigned int}]{time\+Out\+\_\+ms = {\ttfamily 0} }\end{DoxyParamCaption})}
...
-\/2 error while reading the byte 
\end{DoxyReturn}
\Hypertarget{classserialib_ab155c84352ddefe1304d391c19497ac1}\label{classserialib_ab155c84352ddefe1304d391c19497ac1} 
...
{\footnotesize\ttfamily int serialib\+::read\+String (\begin{DoxyParamCaption}\item[{char \texorpdfstring{$\ast$}{*}}]{received\+String,  }\item[{char}]{final\+Char,  }\item[{unsigned int}]{max\+Nb\+Bytes,  }\item[{const unsigned int}]{time\+Out\+\_\+ms = {\ttfamily 0} }\end{DoxyParamCaption})}
...
\hline
{\em max\+Nb\+Bytes} & \+: maximum allowed number of characters read \\
\hline
{\em time\+Out\+\_\+ms} & \+: delay of timeout before giving up the reading (optional) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\texorpdfstring{$>$}{>}0 success, return the number of bytes read (including the null character) 

0 timeout is reached 

-\/1 error while setting the Timeout 

-\/2 error while reading the character 

-\/3 Max\+Nb\+Bytes is reached 
\end{DoxyReturn}
\Hypertarget{classserialib_a5a73f159762fa4d5c252f36acfe7ab47}\label{classserialib_a5a73f159762fa4d5c252f36acfe7ab47} 
...
\end{DoxyReturn}
\Hypertarget{classserialib_a7564b9e28b1b50675d9d6d3fabc896c0}\label{classserialib_a7564b9e28b1b50675d9d6d3fabc896c0} 
...
If the function fails, the return value is false If the function succeeds, the return value is true. 
\end{DoxyReturn}
\Hypertarget{classserialib_a21767ffe86a76f300a71c496fbcc26a1}\label{classserialib_a21767ffe86a76f300a71c496fbcc26a1} 
...
If the function fails, the return value is false If the function succeeds, the return value is true. 
\end{DoxyReturn}
\Hypertarget{classserialib_ae5cfd575df8030105cf321e645e5db85}\label{classserialib_ae5cfd575df8030105cf321e645e5db85} 
...
{\footnotesize\ttfamily int serialib\+::write\+Bytes (\begin{DoxyParamCaption}\item[{const void \texorpdfstring{$\ast$}{*}}]{Buffer,  }\item[{const unsigned int}]{Nb\+Bytes }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classserialib_ae0fd2e82018850e8d503a395be068589}\label{classserialib_ae0fd2e82018850e8d503a395be068589} 
...
-\/1 error while writting data 
\end{DoxyReturn}
\Hypertarget{classserialib_ab6ddd91886eec65d3b727532e2b3d710}\label{classserialib_ab6ddd91886eec65d3b727532e2b3d710} 
...
{\footnotesize\ttfamily int serialib\+::write\+String (\begin{DoxyParamCaption}\item[{const char \texorpdfstring{$\ast$}{*}}]{received\+String }\end{DoxyParamCaption})}
...
\item 
/home/jp/opiskelu/advanced\+\_\+cpp/loppuprojekti/\mbox{\hyperlink{serialib_8h}{serialib.\+h}}\item 
/home/jp/opiskelu/advanced\+\_\+cpp/loppuprojekti/\mbox{\hyperlink{serialib_8cpp}{serialib.\+cpp}}\end{DoxyCompactItemize}
